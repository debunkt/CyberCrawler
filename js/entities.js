...
const ENEMY_CONFIGS = {
  gangster: {
    ...
    atkRange: 1, sight: 7, desc: 'Melee aggressor.',
  },
  ncpd: {
    name: 'NCPD Officer', sym: 'N', color: COLORS.ENEMY_NCPD, glow: COLORS.ENEMY_NCPD,
    hp: 30, atk: 14, def: 2, hackDef: 8, xp: 15, rangeAtk: true, hackPower: 0,
    atkRange: 8, sight: 10, ammo: 12, desc: 'Ranged officer.',
  },
  drone: {
    name: 'Security Drone', sym: 'D', color: COLORS.ENEMY_DRONE, glow: COLORS.ENEMY_DRONE,
    hp: 25, atk: 12, def: 3, hackDef: 15, xp: 20, rangeAtk: true, hackPower: 0,
    atkRange: 10, sight: 12, ammo: 20, flying: true, desc: 'Aerial combat unit.',
  },
  netrunner: {
    name: 'Netrunner', sym: 'R', color: COLORS.ENEMY_RUNNER, glow: COLORS.ENEMY_RUNNER,
    hp: 20, atk: 5, def: 0, hackDef: 20, xp: 25, rangeAtk: false, hackPower: 25,
    atkRange: 1, hackRange: 10, sight: 10, desc: 'Remote hacker. Drains energy.',
  },
  corp: {
    name: 'Corp Soldier', sym: 'S', color: COLORS.ENEMY_CORP, glow: COLORS.ENEMY_CORP,
    hp: 55, atk: 18, def: 5, hackDef: 10, xp: 30, rangeAtk: true, hackPower: 0,
    atkRange: 10, sight: 10, ammo: 15, desc: 'Militech mercenary.',
  },
  maxtac: {
    name: 'MaxTac Elite', sym: 'M', color: COLORS.ENEMY_MAXTAC, glow: COLORS.ENEMY_MAXTAC,
    hp: 85, atk: 28, def: 10, hackDef: 20, xp: 50, rangeAtk: true, hackPower: 0,
    atkRange: 8, sight: 12, ammo: 20, desc: 'Special police cyborg.',
  },
  boss: {
    name: 'Arasaka Operative', sym: 'B', color: COLORS.ENEMY_BOSS, glow: COLORS.ENEMY_BOSS,
    hp: 220, atk: 35, def: 15, hackDef: 30, xp: 200, rangeAtk: true, hackPower: 30,
    atkRange: 10, hackRange: 8, sight: 14, ammo: 30, desc: 'Elite corporate assassin.',
  },
};
